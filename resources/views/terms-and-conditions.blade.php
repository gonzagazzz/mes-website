...
<html>
<head>
	<title>Terms and Conditions - MES Modder's Repository</title>
	...
	<div class="container" style="margin-top: 60px; margin-bottom: 100px;">
		<div class="row">
			<div class="col">
				...
				<p>These terms and conditions ("Terms", "Agreement") are an agreement between Website Operator ("Website Operator", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the <a target="_blank" rel="nofollow" href="https://mes-repository.000webhostapp.com">mes-repository.000webhostapp.com</a> website and any of its products or services (collectively, "Website" or "Services").</p>
			</div>
		</div>
		<div class="row">
			<div class="col">
		...
		<div class="row" style="margin-top: 30px;">
			<div class="col">
				<p>This document was last updated on November 14, 2018</p>
			</div>
		</div>
	</div>
